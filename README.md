...
- **Tekrar eden işi paylaşan motor:** Tornado on bir, kredi taraması on üç
  ...
  yeniden hesaplatmaz. Üç ağır panelin toplamı **50.000 iterasyonda 1894 ms →
  320 ms**, 10.000'de 380 ms → 70 ms; 25 olasılığın hepsi birebir aynı.
...
- **Opsiyonel Numba Hızlandırma:** Çekirdek NumPy ile zaten hızlı — 20.000
  senaryoda sıcak döngü **2.4 ms** (Windows/Py3.14, 2026-07-23; ara diziler
  yerinde yazıldıktan sonra. Aynı ölçüm bu yazımdan önce 9.4 ms'ti). numba
